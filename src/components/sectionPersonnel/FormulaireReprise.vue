    ...
    <main style="width: 80%; margin: auto;">
            ...
            <div class="hot">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-12 header-info">
                        <h1 class="titre">
                            <span class="d-block text-dark ">Fiche de reprise de <span
        ...
        <section
            ...
            <div class="search">
                ...
                <button @click="enregistrerPrise" class="prise">Reprendre
                    Service</button>
            </div>
    ...
    <div class="containerLog" v-if="Enregistrement">
        <form @submit.prevent="createPriseServiceRepriseService" class="form">
            <div v-if="currentPart === 1" class="NewAnim">
                ...
                <h1 class="title">Fiche de reprise de service</h1>
                <div class="group">
                </div>
                <div class="group">
                    <div class="form-group">
                        ...
                        <input type="text" placeholder="Optionel" id="id_perso"
                            v-model="priseServiceRepriseService.id_perso" class="input" required />
                    </div>
                    <div class="form-group">
                ...
                <div class="group">
                    ...
                    <div class="form-group">
                        <label for="specialite" class="label">Justificatif</label>
                        <input type="text" placeholder="Quelle est votre Justificatif?" id="specialite"
                            v-model="priseServiceRepriseService.justificatif" class="input" />
                    </div>
                </div>
                <div class="group">
                    <div class="form-group">
